...
2. In the class Controller.java, there's a variable called 'useCache' - it determines whether the app should cache HTTP responses and therefore offer offline visualization of the products as long as they had been accessed before.
